...
class cifar_dataloader():  
    def __init__(self, dataset, r, imb_factor,noise_mode, batch_size, num_workers, root_dir,log):
        ...
        train_data ,train_label=sample_dataset_1(train_data ,train_label,img_num_list,num_classes,'select')
...
def sample_dataset_1(train_data,train_label, img_num_list, num_classes, kind):
    """
    Args:
        dataset
        img_num_list
